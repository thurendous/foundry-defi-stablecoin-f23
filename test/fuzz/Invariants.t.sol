...
contract Invariants is StdInvariant, Test {
    ...
    function setUp() public {
        ...
        // hey, don't call redeemCollater unless there is collater to redeem
        handler = new Handler(dsce, dsc);
        targetContract(address(handler)); // it will call the handler's function
    }
    ...
    function invariant_protocolMustHaveMoreValueThanTotalSupply() public {
        ...
        assertEq(totalSupply <= wethValue + wbtcValue, true); // this will always hold!! this is called the invariant
